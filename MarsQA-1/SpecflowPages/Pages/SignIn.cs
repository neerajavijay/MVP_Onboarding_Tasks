...
namespace MarsQA_1.Pages
{
    public static class SignIn
    {
        ...
        public static void Login()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("(//INPUT[@type='text'])[2]")).SendKeys("neerajavijay18@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//INPUT[@type='password']")).SendKeys("Neeraja@123");
